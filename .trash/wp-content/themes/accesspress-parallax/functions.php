...
function style_enqueue(){
	...
	wp_enqueue_style('mycss', get_template_directory_uri().'/css/mystyle.css', array(), '', 'all');
	wp_enqueue_script('myjs', get_template_directory_uri().'/js/mystyle.js', array('jquery'), null, true);
}
